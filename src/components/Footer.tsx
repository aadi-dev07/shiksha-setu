      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white text-xl">ShikshaSetu</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">support@shikshasetu.org</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} ShikshaSetu. All rights reserved. Made with ❤️ for rural India.
          </p>
        </div>
      </div>
    </footer>
